...
const sidebarLinks = [
  ...
  { to: "/validador-estatus-stripe", label: "🔍 Validador Estatus Stripe", section: "buscadores" },
  ...
  { to: "/analisis-comentarios", label: "💬 Análisis de Comentarios", section: "analisis" },
  { to: "/procesar-documentos", label: "📄 Procesar Documentos", section: "herramientas" },
  { to: "/papeleria", label: "📋 Papelería OCR", section: "herramientas" },
  { to: "/actualizacion-masiva", label: "🔄 Actualización Masiva", section: "herramientas" },
];
