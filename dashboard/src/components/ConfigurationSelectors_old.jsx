  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
          <label htmlFor="tipo_pago" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            💰 Tipo de Pago
          </label>
          <select
            id="tipo_pago"
            value={config.tipo_pago}
            onChange={(e) => handleChange('tipo_pago', e.target.value)}
            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
          >
            <option value="ANTICIPO A PAQUETE NUEVO">� Anticipo a Paquete Nuevo</option>
