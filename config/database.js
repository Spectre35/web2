...
// ✅ CONFIGURACIÓN DE BASE DE DATOS - USANDO NEON
// 📝 Base de datos Neon (ACTIVA)
const DATABASE_URL_NEON = "postgresql://neondb_owner:npg_OnhVP53dwERt@ep-sweet-bird-aeqhnyu4-pooler.c-2.us-east-2.aws.neon.tech:5432/buscadores?sslmode=require";

// 🆕 BASE DE DATOS SUPABASE (COMENTADA COMO RESPALDO)
// const DATABASE_URL_SUPABASE = "postgresql://postgres.jgcpvvzrqbuioktlxkzt:supaeurobase@aws-1-us-east-1.pooler.supabase.com:6543/postgres";

// ✅ Conexión a la base de datos - usando Neon como principal
export const pool = new Pool({
  connectionString: DATABASE_URL_NEON,
  ssl: {
